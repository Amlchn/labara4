...
public class GraphicsDisplay extends JPanel {
	private Double [][] graphicsData;
	 ...
	 public GraphicsDisplay() {
		 ...
		 graphicsStroke = new BasicStroke(0.5f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND, 10.0f, new float[] {3, 1, 1, 2,2}, 0.0f);
		 axisStroke = new BasicStroke(2.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f, null, 0.0f);
		 markerStroke = new BasicStroke(2.0f, BasicStroke.CAP_SQUARE, BasicStroke.JOIN_MITER, 90.0f, null , 0.0f);
	 ...
	 public void setShowAxis(boolean showAxis) {
		 this.showAxis = showAxis; repaint();
		 }
	 ...
	 protected void paintMarkers(Graphics2D canvas) {
		 ...
		 canvas.setColor(Color.GREEN); else
			 if(integer<0) canvas.setColor(Color.RED);
		 else
		 canvas.setColor(Color.BLACK);
